...
class TemplatesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create template" do
    assert_difference('Template.count') do
      post templates_url, params: { template: { text: @template.text, title: @template.title, user_email: @template.user_email } }
    end
  ...
  test "should update template" do
    patch template_url(@template), params: { template: { text: @template.text, title: @template.title, user_email: @template.user_email } }
