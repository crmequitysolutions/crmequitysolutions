...
class CommunitiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create community" do
    assert_difference('Community.count') do
      post communities_url, params: { community: { community_id: @community.community_id, community_name: @community.community_name, zip_code: @community.zip_code } }
    end
  ...
  test "should update community" do
    patch community_url(@community), params: { community: { community_id: @community.community_id, community_name: @community.community_name, zip_code: @community.zip_code } }
