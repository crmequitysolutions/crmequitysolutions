class Property < ApplicationRecord
    ...
    def not_negative
        errors.add(:time_on_mrkt, "Time on mrkt must be nonnegative") if
            !time_on_mrkt.blank? and time_on_mrkt < 0
        ...
        errors.add(:roof_age, "Roof age must be nonnegative") if
            !roof_age.blank? and roof_age < 0
        errors.add(:plumb_age, "Plumb age must be nonnegative") if
            !plumb_age.blank? and plumb_age < 0
        errors.add(:yr_built, "Yr built must be nonnegative") if
            !yr_built.blank? and yr_built < 0
        errors.add(:heat_age, "Heat age must be nonnegative") if
            !heat_age.blank? and heat_age < 0
        errors.add(:cool_age, "Cool age must be nonnegative") if
            !cool_age.blank? and cool_age < 0
